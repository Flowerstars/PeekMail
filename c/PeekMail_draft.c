...
// Draft Box
WINDOW_TABLE(MMI_PEEK_MAIL_DRAFT_WIN_TAB) =
{
	WIN_ID(MMI_PEEK_MAIL_DRAFT_WIN_ID),
	WIN_FUNC((uint32)HandlePeekMailDraftWinMsg),
	WIN_TITLE(TXT_PEEKMAIL_DRAFTS_TITLE),
	CREATE_LISTBOX_CTRL(GUILIST_TEXTLIST_E, MMI_PEEK_MAIL_DRAFT_CTRL_ID),
	WIN_SOFTKEY(TXT_PEEKMAIL_MENU, TXT_PEEKMAIL_VIEW, TXT_PEEKMAIL_BACK),
	END_WIN
};

// Draft Menu (left softkey)
WINDOW_TABLE( MMI_PEEK_MAIL_DRAFT_MENU_TAB ) = 
{
	WIN_ID(MMI_PEEK_MAIL_DRAFT_MENU_WIN_ID),
    WIN_FUNC((uint32)HandlePeekMailDraftMenuWinMsg),
    WIN_STYLE(WS_HAS_TRANSPARENT),
    CREATE_POPMENU_CTRL(MENU_PEEKMAIL_DRAFT_MENU, MMI_PEEK_MAIL_DRAFT_MENU_CTRL_ID),
    WIN_SOFTKEY(STXT_OK,TXT_NULL,STXT_RETURN),
    END_WIN
};

MMIPEEKMAIL_WINDOW_ID_E g_win_id_draft = MMI_PEEK_MAIL_DRAFT_WIN_ID;
                                         ...
                                         )
{
	...
	MMI_CTRL_ID_T	  	ctrl_id		 = MMI_PEEK_MAIL_DRAFT_CTRL_ID;
	...
	*********************************/
	...
	case MSG_CTL_OK:
        MMK_CreateWin((uint32 *)MMI_PEEK_MAIL_DRAFT_MENU_TAB, PNULL);
        break;
                                         ...
                                         )
{
	...
	MMI_CTRL_ID_T	  	ctrl_id		= MMI_PEEK_MAIL_DRAFT_MENU_CTRL_ID;
...
{
   MMK_CreateWin((uint32*)MMI_PEEK_MAIL_DRAFT_WIN_TAB, PNULL);
}
